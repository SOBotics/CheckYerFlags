debug_config = {
    ...
    "botVersion": "v0.11.0", # The current version of the Bot, be sure to read the wiki on how to increment the version
    ...
    "redundaKey": "" # Just leave this empty unless you're sure what you're doing. If you think you need a key from me, we can discuss it in chat.
}
